            ...
            INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                    ...
                    .addCallback(new Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            super.onCreate(db);
                            db.execSQL("INSERT INTO Book (name, description, cover, category, author, year, reqNumber) VALUES ('Cara Senhora Tosoni Os postais da Casabella', 'Este é um livro carregado de ironia, erudição, imagens e violência. Violência da construção, imagens de arquitectura, erudição e ironia do autor que, entre 1982 e 1995, enviou regularmente postais à Senhora Tosoni, a secretária da redacção da revista milanesa Casabella, então dirigida por Vittorio Gregotti.\n" +
                                    "\n" +
