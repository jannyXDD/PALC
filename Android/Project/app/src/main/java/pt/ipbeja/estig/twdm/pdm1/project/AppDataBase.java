            ...
            INSTANCE = Room.databaseBuilder(context.getApplicationContext(),
                    ...
                    .addCallback(new Callback() {
                        ...
                        public void onCreate(@NonNull SupportSQLiteDatabase db) {
                            super.onCreate(db);
                            db.execSQL("INSERT INTO Book (name, description, cover, category, author) VALUES ('Cara Senhora Tosoni Os postais da Casabella', 'Este é um livro carregado de ironia, erudição, imagens e violência. Violência da construção, imagens de arquitectura, erudição e ironia do autor que, entre 1982 e 1995, enviou regularmente postais à Senhora Tosoni, a secretária da redacção da revista milanesa Casabella, então dirigida por Vittorio Gregotti.\n" +
                                    "\n" +
                                    ...
                                    "\n" +
                                    "A arquitectura, o design industrial, a história do movimento moderno, os autores e os veículos da arte, da pintura, da literatura e do conhecimento são convocados numa interrogação constante ao sentido das imagens do mundo.', 'https://almedinanet.b-cdn.net/media/catalog/product/cache/10f519365b01716ddb90abc57de5a837/9/7/9789898217530_1614333762.jpg', 'Artes', 'Jacques Gubler')");
                            db.execSQL("INSERT INTO Book (name, description, cover, category, author) VALUES ('Espectros do Cinema', 'Este livro é uma galeria de retratos de figuras que, como se diz em Benilde, «não são deste mundo», figuras fantasmáticas, prometidas a uma existência liminar, que adquirem uma espécie de inteireza justamente na sua inconsistência ôntica.\n" +
                                    "\n" +
